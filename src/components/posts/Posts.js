    ...
    <div className='flexItem postContainer'>
      ...
      <div key={index}  className='postContainer'>
        <div className='flexboxContainer postSection'>
          <p>Posted by <span><a href={`https://www.reddit.com/user/${element.data.author}/`} target="_blank">{element.data.author}</a></span><span>    {timeConverter(element.data.created)}</span></p>
        </div>
